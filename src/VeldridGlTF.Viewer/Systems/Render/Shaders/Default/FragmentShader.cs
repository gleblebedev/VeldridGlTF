...
#line hidden
    ...
    if (Context.IsFlagSet(ShaderFlag.HAS_DIFFUSE_MAP))
	{
            ...
            #line 25 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"
	...
	{
		WriteLine("light = normalize({0}).y*0.5+0.5;", Context.Normal.Name);
	}
    else if (Context.TBN != null)
	{
		WriteLine("light = normalize({0}[2]).y*0.5+0.5;", Context.TBN.Name);
	}
    if (Context.IsFlagSet(ShaderFlag.HAS_DIFFUSE_MAP) && Context.TexCoord0 != null)
	{
            ...
            #line 50 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"
