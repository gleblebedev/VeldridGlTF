    ...
    public partial class FragmentShader : FragmentShaderBase
    {
        ...
        public virtual string TransformText()
        {
            Write("#version 450\r\n\r\nstruct MaterialPropertiesInfo\r\n{\r\n    vec4 BaseColor;\r\n};\r\n\r\nlayo" +
                  "ut(set = 0, binding = 2) uniform textureCube CubeTexture;\r\nlayout(set = 0, bindi" +
                  "ng = 3) uniform sampler CubeSampler;\r\n\r\n");

#line 16 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"

            if (Context.IsFlagSet(ShaderFlag.HAS_DIFFUSE_MAP))
            {
#line default
#line hidden
                Write("layout(set = 2, binding = 0) uniform texture2D SurfaceTexture;\r\nlayout(set = 2, b" +
...
#line 27 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"
            }
...
#line default
#line hidden
                Write("\t//fsout_color = texture(samplerCube(CubeTexture, CubeSampler), normal);\r\n    fso" +
                      "ut_color = texture(sampler2D(SurfaceTexture, SurfaceSampler), ");

#line 55 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"
                Write(ToStringHelper.ToStringWithCulture(Context.TexCoord0.Name));

#line default
#line hidden
                Write(") * vec4(light,light,light,light);\r\n");
...
#line 62 "E:\MyWork\VeldridGlTF\src\VeldridGlTF.Viewer\Systems\Render\Shaders\Default\FragmentShader.tt"
            }
